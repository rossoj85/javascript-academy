...
const connectionString = process.env.DATABASE_connectionString || `postgres://localhost:5432/${pkg.name}` || process.env.DATABASE_URL;
...
function sync(force, retries=0, maxRetries=5) {
  return db.sync()
